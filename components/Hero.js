        ...
        <div className="mb-8 space-y-4">
          {startTextAnimation && (
            <SplitText
              ...
              tag="h1"
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-forest-900 font-display leading-tight"
            />
          )}
          {startTextAnimation && (
            <SplitText
              ...
              tag="h1"
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-forest-600 font-display leading-tight"
            />
          )}
        </div>
