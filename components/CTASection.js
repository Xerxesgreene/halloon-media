...
export default function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-32 px-4 bg-gradient-to-b from-cream-100 to-cream-50 overflow-hidden">
      ...
      >
        <h2 className="text-4xl md:text-6xl font-bold text-forest-900 mb-6 font-sans-serif">
        ...
        <p className="text-lg text-forest-700 mb-8 max-w-2xl mx-auto">
          Let's begin your journey with a discovery session to finalize design, plan and objectives
        </p>
